                      ################################################################################
                      #             This script is for all PED analysis by Brand                     #
                      #                 **All product PED BY BRAND/MODEL**                           #
                      #                     Created by: CHLOE LI                                     #
                      ...
                      #extract only top sellers brand/model (cutoff - 1500 orders and above per brand/model)
                      filtered_brand <- filter(CountBrand, Num_Orders > 1500 & brand_model != "\\t" & brand_model != "" & brand_model != "NULL") %>%
